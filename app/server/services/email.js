...
controller.sendRejectionEmail = function(email, callback) {
  ...
  var options = {
    to: email,
    subject: "["+HACKATHON_NAME+"] - You've not been admitted to hackathon x"
  };
...
controller.sendAdmissionEmail = function(email, callback) {
  ...
  var options = {
    to: email,
    subject: "[ACTION REQUIRED] ["+HACKATHON_NAME+"] - You've been accepted for hackathon x!"
  };
...
controller.sendConfirmationEmail = function(email, callback) {
  ...
  var options = {
    to: email,
    subject: "["+HACKATHON_NAME+"] - We have received your confirmation for hackathon x!"
  };
